...
int main() {
    ...
    const char* file_in = "C:\\Users\\cornelia.blanke\\Documents\\adv\\iofile\\iofdata2.in";

    // Nombre de lignes / Colones de titres
    const int nbTitleLines = 2;
    const int nbTitleColumns = 2;

    // Debut du traitement
    cout << "Test Input Output file : " << file_in << endl << endl;
