...
public:
  ...
  virtual int write(GA_CPPSTD(ostream)&) const {return 0;}
  virtual int read(const char*){return 0;}
  virtual int read(GA_CPPSTD(istream)&){return 0;}
#endif
  ...
  const GAParameterList& parameters(GA_CPPSTD(istream)&, GABoolean flag=gaFalse);
#endif
