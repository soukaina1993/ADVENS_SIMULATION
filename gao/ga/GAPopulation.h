...
#ifndef NO_STREAMS
  virtual void read(GA_CPPSTD(istream) &){}
  virtual void write (GA_CPPSTD(ostream) & os, SortBasis basis=RAW) const;
#endif
...
#ifndef NO_STREAMS
inline GA_CPPSTD(ostream)& operator<< (GA_CPPSTD(ostream)& os, const GAPopulation & arg)
{ arg.write(os); return os; }
inline GA_CPPSTD(istream)& operator>> (GA_CPPSTD(istream)& is, GAPopulation & arg)
