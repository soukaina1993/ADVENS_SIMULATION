// $Header: /nfs/dsi/cvs/galib/ga/GANode.h,v 1.1.1.1 1999/11/11 18:56:03 mbwall Exp $
/* ----------------------------------------------------------------------------
  node.h
  mbwall 25nov94
...
#ifndef NO_STREAMS
inline GA_CPPSTD(ostream) & operator<<(GA_CPPSTD(ostream) & os, GANodeBASE & arg){
  os << "  node:   " << &arg << "\n";
  os << "  next:   " << arg.next << "\n";
  os << "  prev:   " << arg.prev << "\n";
  os << "  child:  " << arg.child << "\n";
...
#ifndef NO_STREAMS
template <class T> GA_CPPSTD(ostream) & operator<<(GA_CPPSTD(ostream) & os, GANode<T> & arg){
  os << "  node:   " << &arg << "\n";
  os << "  next:   " << arg.next << "\n";
  os << "  prev:   " << arg.prev << "\n";
  os << "  child:  " << arg.child << "\n";
