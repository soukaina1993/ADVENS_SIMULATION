...
public:
  ...
  virtual void copy(const GASelectionScheme& orig) {
    ...
    n = sel.n; 
    psum = new float[n];
    GA_CSTD(memcpy)(psum, sel.psum, n * sizeof(float));
  }
  virtual GAGenome& select() const;
  virtual void update();
...
public:
  ...
  virtual void copy(const GASelectionScheme& orig) {
    ...
    GA_CSTD(memcpy)(fraction, sel.fraction, n * sizeof(float));
    GA_CSTD(memcpy)(choices, sel.choices, n * sizeof(unsigned int));
  }
  virtual GAGenome& select() const;
  virtual void update();
...
public:
  ...
  virtual void copy(const GASelectionScheme& orig) {
    ...
    GA_CSTD(memcpy)(fraction, sel.fraction, n * sizeof(float));
    GA_CSTD(memcpy)(choices, sel.choices, n * sizeof(unsigned int));
    GA_CSTD(memcpy)(idx, sel.idx, n * sizeof(unsigned int));
  }
  virtual GAGenome& select() const;
  virtual void update();
