...
public:
  ...
  int read(GA_CPPSTD(istream)& is, GABoolean flag=gaTrue);
#endif
...
#ifndef NO_STREAMS
inline GA_CPPSTD(ostream)& operator<< (GA_CPPSTD(ostream)& os, const GAParameterList& plist)
{ plist.write(os); return os; }
inline GA_CPPSTD(istream)& operator>> (GA_CPPSTD(istream)& is, GAParameterList& plist)
